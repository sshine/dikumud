  ...
  struct char_data *victim, struct obj_data *obj)
{
  ...
  tmp_obj->name = our_strdup("mushroom");
  tmp_obj->short_description = our_strdup("A Magic Mushroom");
  tmp_obj->description = our_strdup("A really delicious looking magic mushroom lies here.");
